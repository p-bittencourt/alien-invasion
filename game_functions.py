...
def check_keydown_events(event, ai_settings, screen, stats, sb, ship, aliens, bullets):
    ...
    if event.key == pygame.K_RIGHT:
        ...
        if stats.game_active:
            ...
            restart(ai_settings, screen, stats, sb, ship, aliens, bullets)  
...
def restart(ai_settings, screen, stats, sb, ship, aliens, bullets):
    '''Restarts the game settings.'''
...
def check_bullet_alien_collision(ai_settings, screen, stats, sb, ship, aliens, bullets):
    ...
    # Remove any alien and bullets that have collided.
    collisions = pygame.sprite.groupcollide(bullets, aliens, True, True)
    # Awards score points for each alien hit.
    if collisions:
...
def update_aliens(ai_settings, stats, sb, screen, ship, aliens, bullets):
    '''
    Check if the fleet has reached an edge, and then
